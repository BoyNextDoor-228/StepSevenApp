...
export default function Model(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF(require('./pushups.gltf'))
    ...
    <group ref={group} {...props} dispose={null}>
      <group rotation={[Math.PI / 2, 0, 0]} scale={0.01}>
        ...
        <skinnedMesh
          ...
          material={materials['Цвет тела.009']}
...
useGLTF.preload(require('./pushups.gltf'))
